 ...
 */
class ShiftBreakIntervalParent extends \api\modules\v1\models\ShiftBreakInterval
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['company_id', 'employee_id', 'shift_id', 'added', 'added_by'], 'required'],
            [['company_id', 'employee_id', 'shift_id', 'in_location_at_start_initial', 'in_location_at_stop_initial', 'added_by', 'updated_by', 'deleted'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'shift_id' => Yii::t('api-hr', 'Shift ID'),
