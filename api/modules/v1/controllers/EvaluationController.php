...
use api\modules\v1\models\EvalKpi;
use api\modules\v1\models\Evaluation;
use api\modules\v1\models\EvaluationKpi;
use api\modules\v1\models\User;
use api\modules\v2\models\Employee;
use api\modules\v1\models\EvalKpiCategory;
use api\modules\v2\models\ApprovalHistory;
use common\components\HttpStatus;
use Exception;
use Yii;

class EvaluationController extends RestV1Controller
{
    ...
    public function actionEmployees()
    {
        ...
        foreach ($orderedEmployees as $employeeID) {
            ...
            if (
                ...
                empty($employee->employeeMainCompany->department) ||
                empty($employee->employeeMainCompany->positionCor)
            ) {
                continue;
            }
            $this->return['employees_order'][] = $employee->id;
            ...
            $this->return['employees_details'][$employeeID] = [
                ...
                'department_name' => !empty($employee->employeeMainCompany->department->name) ? $employee->employeeMainCompany->department->name : null,
                'office_name' => !empty($employee->employeeMainCompany->office) ? $employee->employeeMainCompany->office->name : null,
                'position_name' => !empty($employee->employeeMainCompany->positionCor) ? $employee->employeeMainCompany->positionCor->name : null,
