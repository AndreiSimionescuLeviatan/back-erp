...
class SignupFormTest extends \Codeception\Test\Unit
{
    ...
    public function testCorrectSignup()
    {
        ...
        /** @var \backend\modules\adm\models\User $user */
        $user = $this->tester->grabRecord('backend\modules\adm\models\User', [
            'username' => 'some_username',
            'email' => 'some_email@example.com',
            'status' => \backend\modules\adm\models\User::STATUS_INACTIVE
        ]);
