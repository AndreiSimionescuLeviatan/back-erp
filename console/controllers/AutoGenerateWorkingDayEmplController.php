...
use backend\modules\hr\models\WorkingDayEmpl;
use Exception;
use Yii;
use yii\base\InvalidConfigException;
use yii\console\Controller;

class AutoGenerateWorkingDayEmplController extends Controller
{
    /**
    ...
    public function actionIndex($companyID, $year, $month)
    {
        ...
        foreach ($employees as $employee) {
            ...
            //if yes, skip
            $check = WorkingDayEmpl::findAllByAttributes([
            ...
            for ($i = 1; $i <= $daysInMonth; $i++) {
                ...
                try {
                    ...
                    WorkingDayEmpl::createByAttributes([
                        'company_id' => $companyID,
                        'employee_id' => $employee->employee_id,
                        'year' => $currentYear,
                        'month' => $currentMonth,
                    ...
                    $myMes = Yii::t('cmd-hr', 'The working day empl could not be saved') . "\n";
