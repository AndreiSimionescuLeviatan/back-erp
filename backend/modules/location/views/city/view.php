...
$this->params['breadcrumbs'][] = ['label' => Yii::t('location', 'Cities'), 'url' => ['index']];
            ...
            <div class="col-6">
                ...
                <?php echo DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            'label' => Yii::t('location', 'County Code'),
                        ...
                        [
                            'label' => Yii::t('location', 'Country Code'),
                ...
                <div class="row">
                    <div class="col-6">
                        <?php echo Html::a(
                            ...
                            ), Url::previous('city'), ['class' => 'btn btn-info']);
                        ?>
                    </div>
                    <div class="col-6 text-right item_action_btns_container">
                        <?php
                        if (Yii::$app->user->can('activateCounty') && $model->deleted === 1) {
