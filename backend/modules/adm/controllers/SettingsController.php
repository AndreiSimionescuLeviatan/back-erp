...
use backend\modules\adm\models\forms\SettingsSearch;
use yii\helpers\Url;
...
class SettingsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', Yii::t('adm', "Setting successfully added."));
            return $this->redirect(Url::previous('settings'));
        }
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', Yii::t('adm', "Setting successfully updated."));
            return $this->redirect(Url::previous('settings'));
        }
