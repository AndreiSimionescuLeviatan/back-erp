...
/**
 * SubdomainSearch represents the model behind the search form of `backend\modules\adm\models\Subdomain`.
 */
class SubdomainSearch extends Subdomain
{
    ...
    {
        return [
            [['id', 'domain_id', 'entity_id', 'deleted', 'added_by', 'updated_by'], 'integer'],
