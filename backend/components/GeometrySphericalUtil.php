...
class GeometrySphericalUtil
{
    ...
    public static function computeHeading($from, $to)
    {
        ...
        return GeometryMathUtil::wrap(rad2deg($heading), -180, 180);
    }
    ...
    {
        $distance /= GeometryMathUtil::EARTH_RADIUS;
    ...
    {
        return GeometryMathUtil::arcHav(GeometryMathUtil::havDistance($lat1, $lat2, $lng1 - $lng2));
    }
    ...
    {
        return self::computeAngleBetween($from, $to) * GeometryMathUtil::EARTH_RADIUS;
    }
    ...
    public static function computeLength($path)
    {
        ...
        return $length * GeometryMathUtil::EARTH_RADIUS;
    }
    ...
    {
        return self::computeSignedAreaP($path, GeometryMathUtil::EARTH_RADIUS);
    }
