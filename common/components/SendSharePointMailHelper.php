...
class SendSharePointMailHelper
{
    /**
     * @var string
     */
...
//    {
//        if (empty($this->sender['emailAddress']['name']) || empty($this->sender['emailAddress']['address'])) {
//            throw new BadRequestHttpException(Yii::t('app', "No data for sender"));
//        }
//    }
